...
@CucumberOptions(
		...
		features = "src/test/java/com/CareGiver/features", glue = { "com.CareGiver.stepDefinitions",
				"com.CareGiver.Base",
				"com.CareGiver.config" }, tags = { "@Sanity" }, monochrome = true, dryRun = false, plugin = { "pretty",
