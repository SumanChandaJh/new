...
Feature: Legal Representative Form in LTC Digital-Storefront
  I want to see new Legal Representative Form and Submit a request for the same.

  @FormFields
  Scenario Outline: Verify Legal Representative Form Fields
